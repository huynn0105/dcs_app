...
class DialogUtils {
  static Future<void> showYesNoDialog({
    ...
    await Get.dialog(AlertDialog(
      title: Text(
        title,
        style: TextStyleUtil.medium(14).copyWith(
          color: Colors.black,
        ),
      ),
      content: body != null
          ...
          : null,
      titleTextStyle: TextStyleUtil.bold(16).copyWith(
        color: Colors.black,
      ),
      contentTextStyle: TextStyleUtil.regular(16).copyWith(
        color: Colors.black,
      ),
      ...
      actions: [
        ElevatedButton(
          ...
          child: Text(
            'No',
            style: TextStyleUtil.regular(14).copyWith(color: Colors.white),
          ),
        ),
        ElevatedButton(
          onPressed: () {
      ...
      CustomDialogSimple(
        ...
        actionButtons: [
          CustomDialogActionButton(
            btnColor: ColorUtil.grey,
            textColor: Colors.white,
            text: btnNoText ?? 'Cancel',
            onPressed: onCancel,
          ),
          CustomDialogActionButton(
            textColor: Colors.white,
