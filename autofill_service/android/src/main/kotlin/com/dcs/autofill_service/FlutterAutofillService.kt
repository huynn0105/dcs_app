...
class FlutterAutofillService : AutofillService() {
    ...
    override fun onFillRequest(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            clientState.putBoolean(
                "isCompatMode",
                request.flags.hasFlag(FLAG_COMPATIBILITY_MODE_REQUEST)
            )
        }
        ...
        try {
            ...
            val activityName =
                packageManager.getApplicationInfo(packageName, PackageManager.GET_META_DATA).run {
                    metaData.getString("com.dcs.autofill_service.ACTIVITY_NAME")
...
//        } else false
    ...
    override fun onSaveRequest(request: SaveRequest, callback: SaveCallback) {
        ...
        val activityName =
            packageManager.getApplicationInfo(packageName, PackageManager.GET_META_DATA).run {
                metaData.getString("com.dcs.autofill_service.SAVE_ACTIVITY_NAME")
        ...
        val startIntent = IntentHelpers.getStartIntent(
            ...
            applicationContext,
            "/autofill_save",
            SaveInfoMetadata(username, isCompatMode)
        )
