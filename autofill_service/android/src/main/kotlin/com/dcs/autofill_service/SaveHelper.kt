...
object SaveHelper {
    fun createSaveInfo(
        clientState: Bundle,
        autoFillIdUsernameGuessed: AutofillId?,
        autoFillIdPasswordGuessed: AutofillId?,
        autoFillIdUsernameMatched: AutofillId?,
        autoFillIdPasswordMatched: AutofillId?
    ): SaveInfo? {
...
//        }
    ...
    fun guessAutofillIdsForSave(
        ...
        val usernameId =
            parser.fieldIds[AutofillInputType.NewUserName]?.maxByOrNull { it.heuristic.weight }?.autofillId
        ...
        val passwordId =
            parser.fieldIds[AutofillInputType.NewPassword]?.maxByOrNull { it.heuristic.weight }?.autofillId
