...
import com.dcs.autofill_service.AssistStructureParser
import com.dcs.autofill_service.AutofillInputType
import com.dcs.autofill_service.AutofillMetadata
import com.dcs.autofill_service.AutofillPreferenceStore
import com.dcs.autofill_service.AutofillPreferences
import com.dcs.autofill_service.IntentHelpers.getStartIntent
import com.dcs.autofill_service.RemoteViewsHelper
import com.dcs.autofill_service.SaveHelper
import com.dcs.autofill_service.SaveHelper.createSaveInfo
...
////        } else false
    ...
    val remoteViews = {
      RemoteViewsHelper.simpleRemoteViews(
              context.packageName
      )
    }
//        structure.fieldIds.values.forEach { it.sortByDescending { it.heuristic.weight } }
    ...
    val serviceShortName =
            metaData.getString("com.dcs.autofill_service.service_short_name")
                    ?: "AutoFill"
    val selectAnotherEntryLabel =
            metaData.getString("com.dcs.autofill_service.select_another_entry")
...
//                                }
              ...
              if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                val matchHeaderDrawableName =
                        metaData.getString("com.dcs.autofill_service.match_header_drawable_name")
    ...
    val activityName = metaData.getString("com.dcs.autofill_service.ACTIVITY_NAME")
                ...
                entry.value.map { entry.key to it }
                      ...
                      .forEach allIds@{ (type, field) ->
                        val selectAnotherEntryDrawableName =
                                metaData.getString("com.dcs.autofill_service.select_another_entry_drawable_name")
                        ...
                        val nonInlineResponse = RemoteViewsHelper.simpleRemoteViews(
                                context.packageName
                        )
...
class AutofillServicePlugin : FlutterPlugin, ActivityAware {
  ...
  override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
    val channel =
            MethodChannel(binding.binaryMessenger, "com.dcs/autofill_service")
