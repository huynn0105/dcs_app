  ...
  case 'ask_to_save_new_account':
    if (window == window.top){
      ...
      if (username != undefined && username != null && username != '' && url != undefined && url != null && url != ''){
        chrome.runtime.sendMessage({"directive": "checking_authorized", "username": username, "url": url, "tab_id": tab_id, "window_id": window_id, "is_not_normal": is_not_normal, 'is_from_sign_in_bar': 'true'}, function(response){});
      }
    }
    break;
  }
